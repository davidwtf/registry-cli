...
func delCmd(opts *option.Options) *cobra.Command {
	cmd := &cobra.Command{
		Use:     "del [command options] TAG_OR_DIGEST",
		Short:   "delete the tag or digest",
		Example: `  del -s 127.0.0.1:5000 -r repo1 sha256:74f5f150164eb49b3e6f621751a353dbfbc1dd114eb9b651ef8b1b4f5cc0c0d5`,
